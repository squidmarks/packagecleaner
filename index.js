...
const lidSwitch = new gpio(24, 'in', 'both', {debounceTimeout: 10})
const redSwitch = new gpio(9, 'in', 'both', {debounceTimeout: 10})
const blackSwitch = new gpio(11, 'in', 'both', {debounceTimeout: 10})
