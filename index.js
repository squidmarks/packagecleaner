...
const lidSwitch = new gpio(24, 'in', 'both', {debounceTimeout: 100})
const greenSwitch = new gpio(9, 'in', 'both', {debounceTimeout: 100})
const redSwitch = new gpio(11, 'in', 'both', {debounceTimeout: 100})
