...
const lidSwitch = new gpio(24, 'in', 'both', {debounceTimeout: 500})
const greenSwitch = new gpio(10, 'in', 'both', {debounceTimeout: 500})
const redSwitch = new gpio(9, 'in', 'both', {debounceTimeout: 500})
